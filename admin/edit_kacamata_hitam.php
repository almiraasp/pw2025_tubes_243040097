...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES['foto']['name'] != "") {
        ...
        // Update dengan foto
        $update = mysqli_query($conn, "UPDATE produk_kacamata_hitam SET 
    ...
    if ($update) {
        echo "<script>alert('Data berhasil diupdate!'); window.location='kacamata_hitam.php';</script>";
    } else {
...
<head>
    <title>Edit Kacamata Hitam</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>

<body class="container py-4">
    <h2>Edit Produk Kacamata Hitam</h2>
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <img src="../uploads/kacamata_hitam/<?= $data['gender'] ?>/<?= $data['model']; ?>/<?= $data['gambar']; ?>" width="120" class="my-2">
            <input type="file" name="foto" class="form-control">
        </div>
        <button type="submit" name="submit" class="btn btn-success">Simpan Perubahan</button>
        <a href="kacamata_hitam.php" class="btn btn-secondary">Kembali</a>
    </form>
</body>
