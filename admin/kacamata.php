...
if (!empty($cari)) {
    $queryKacamata = "SELECT * FROM produk_kacamata 
...
// Eksekusi query
$result = mysqli_query($conn, $queryKacamata);
    ...
    <div class="container mt-5">
        ...
        <div class="mt-3">
            ...
            <div class="d-flex align-items-center mt-3">
                <a href="tambah_kacamata.php" class="btn btn-primary mt-3">+ Tambah Produk</a>
                        ...
                        ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="../uploads/kacamata/<?= $data['gender'] ?>/<?= $data['model']; ?>/<?= $data['foto']; ?>" width="100">
                                    </td>
                                    <td>
                                        <a href="edit_kacamata.php?id=<?= $data['id']; ?>" class="btn btn-sm btn-warning m-1 fw-bold">Edit</a>

                                        <a href="hapus_kacamata.php?id=<?= $data['id']; ?>" class="btn btn-sm btn-danger m-1 fw-bold" onclick="return confirm('Yakin ingin menghapus produk ini?')">Hapus</a>
                                    </td>
                                </tr>
                        <?php
                            }
